...
as hieraquias de preferência de cada espécie de pulgão são mantidas, mas tornam-se independentes.
...
hpótese é unicaudal (sobreposição observada menor do que o esperado pelo acaso),
