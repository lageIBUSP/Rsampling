...
```{r rhyzophora distribuicao nula, fig.cap="Distribuição das inclinações da regressão linear do número de raízes em função da razão das áreas da copa e tronco, em 1000 simulações da hipótese nula de ausência de relação. As linhas vermelhas indicam as inclianções observadas.", fig.width=7.5}
par(mfrow=c(1,2))
...
Aplicando nosso critério de significância a cada estatística de interesse:
